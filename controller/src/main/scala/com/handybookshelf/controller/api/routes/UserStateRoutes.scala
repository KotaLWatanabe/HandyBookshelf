...
import com.handybookshelf.usecase.{UserCommandUseCase, UserQueryUseCase, LoginCommandRequest, LogoutCommandRequest, UpdateActivityCommandRequest, GetUserStateRequest, GetAllActiveUsersRequest, GetUsersLoggedInAfterRequest, UseCaseError}
